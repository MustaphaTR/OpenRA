...
WHITELISTED_OPENRA_ASSEMBLIES = OpenRA.Game.exe OpenRA.Utility.exe OpenRA.Platforms.Default.dll OpenRA.Mods.Common.dll OpenRA.Mods.Cnc.dll OpenRA.Mods.D2k.dll OpenRA.Mods.Gen.dll OpenRA.Game.dll
...
install-common-mod-files:
	...
	@$(INSTALL_PROGRAM) mods/common/OpenRA.Mods.Gen.dll "$(DATA_INSTALL_DIR)/mods/common"
