...
namespace OpenRA.Mods.Common.Scripting
{
	...
	public class LightingGlobal : ScriptGlobal
	{
		...
		public double Red
		{
			get
			{
				return hasLighting ? lighting.Red : 1d;
			}
		...
		public double Green
		{
			get
			{
				return hasLighting ? lighting.Green : 1d;
			}
		...
		public double Blue
		{
			get
			{
				return hasLighting ? lighting.Blue : 1d;
			}
		...
		public double Ambient
		{
			get
			{
				return hasLighting ? lighting.Ambient : 1d;
			}
